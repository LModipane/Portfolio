...
export default function Home() {
	return (
		<main className="h-full w-full bg-gray-100 text-black overflow-scroll">
			{/* Hero section */}
			<header className="h-full w-full flex items-center justify-center">
				<div className="flex flex-col items-center border-2 border-gray-300/40 rounded-lg p-8 shadow-lg">
					{/* Availability Tag */}
					<div className="rounded-full p-0.5 bg-linear-to-r from-blue-500 to-purple-600 mb-2 animate-gradient">
					...
					<div className="flex justify-center mt-2 items-center">
						...
						<button className="ml-4 px-6 py-3 bg-gray-100 text-black border-2 border-black rounded-3xl hover:bg-gray-50 transition-colors duration-300 cursor-pointer">
							Download Resume
						</button>
					</div>
